...
Examples:
    CAMB_API_KEY=<key> python scripts/camb_audio_isolation.py -i noisy.wav -o voice.wav

    python scripts/camb_audio_isolation.py -i clip.mp3 -o fg.wav --background-output bg.wav
"""
