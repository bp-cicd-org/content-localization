...
# 1. Run camb_diarize.py on sample BBC audio → diarization JSON
...
INPUT_AUDIO="assets/bbc/sample_bbc_audio.wav"
INPUT_VIDEO="assets/bbc/sample_bbc_video_streamable.mp4"
OUTPUT_DIR="outputs/camb_outputs"
DIARIZATION_FILE="${OUTPUT_DIR}/sample_bbc_diarization_camb.json"
ASD_OUTPUT="${OUTPUT_DIR}/asd_bbc_output.csv"
...
python3 scripts/camb_diarize.py \
